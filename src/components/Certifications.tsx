...
const certs = [
  {
    ...
    desc: "Demonstrates advanced ability to identify vulnerabilities and execute organized attacks under tight time constraints. Validates skills in information gathering, exploit development, privilege escalation, client-side attacks, web application exploitation, tunneling, and Active Directory attacks.",
    tags: ["Privilege Escalation", "Web App Attacks", "Buffer Overflows", "Active Directory", "Antivirus Evasion", "Tunneling & Pivoting", "Bash Scripting", "Exploit Fixing", "Client-Side Attacks", "PowerShell Empire"],
    accent: "#ef4444",
    badge: "OSCP+",
  ...
  },
  {
    ...
    desc: "Demonstrates proficiency in ethical hacking through a challenging hands-on exam requiring successful compromise of multiple systems. Validates practical skills in network vulnerability scanning, buffer overflow exploits, web exploitation, password attacks, pivoting, and Active Directory attacks.",
    tags: ["Network Scanning", "Buffer Overflows", "Web Exploitation", "Password Attacks", "Pivoting", "Active Directory", "Metasploit", "Privilege Escalation", "Public Exploit Fixing", "File Transfers"],
    accent: "#f97316",
    badge: "OSCP",
